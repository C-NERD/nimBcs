...
type
    ...
    Serializables* = CountTable | CountTableRef | OrderedTable |
            OrderedTableRef | Table | TableRef | int128 | uint128 | int256 |
            uint256 | bool | array | seq | SomeInteger | string | enum | Option
