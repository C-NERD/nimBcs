...
suite "bcs serialization and deserialization test": 
  ...
  test "serializing tuple":
    ...
    var 
      bcs : HexString = serialize[tuple[first : int32, second : int64, third : int128, fourth : int256]](ogData)
      data : tuple[first : int32, second : int64, third : int128, fourth : int256] = deSerialize[tuple[first : int32, second : int64, third : int128, fourth : int256]](bcs)
  ...
  test "serializing table":
    ...
    var 
      ...
      data : OrderedTable[string, string] = deSerialize[OrderedTable[string, string]](bcs)
